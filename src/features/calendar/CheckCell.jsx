...
const CheckCell = memo(function CheckCell({
  ...
  return (
    ...
    >
      {/*
        Wrap the visual .chk element in a button with a larger touch target.
        The button is transparent and sits over the cell; the visual dot is inside.
        This guarantees 44×44px tap area on mobile without changing the visual size.
      */}
      <button
        ref={cellRef}
        ...
        style={{
          position: "relative",
          /* On touch devices the CSS media query enlarges .chk to 28px;
             here we also widen the hit area via padding without affecting layout */
          padding: 0,
          border: "none",
