...
export default function DataExport() {
      ...
      const data = {
        ...
        stats: {
          ...
          total_completions: Object.values(completions).reduce(
            (acc, hc) => acc + Object.values(hc).filter(Boolean).length,
            0,
          ),
  ...
  return (
    ...
    >
      ...
      >
        Export backs up all your habits, completions, mood data, and notes as a
        JSON file you can restore anytime.
      </p>
    </Collapsible>
  );
}
