...
export default function AppFooter() {
  ...
  return (
    ...
    >
      <div
        style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 16px 24px" }}
      >
        ...
        >
          ...
          <div style={{ maxWidth: 300, minWidth: 200 }}>
            ...
            >
              Build streaks. Build yourself. A free, open-source habit tracker
        ...
        >
          ...
          >
            ...
            <span
              ...
              style={{ color: "var(--border-hi)", fontSize: 12 }}
            >
              ·
            </span>
            <span
          ...
          >
            {LEGAL_LINKS.map((l, i) => (
              <React.Fragment key={l.label}>
                {i > 0 && (
                  <span style={{ color: "var(--border-hi)", fontSize: 11 }}>
                    ·
                  </span>
                )}
                <a
